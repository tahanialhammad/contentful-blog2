      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 py-12">
        ...
        {/* Rechter kolom */}
          ...
          <p>
            ...
            Het komt van mijn voornaam Tahani en weerspiegelt mijn missie:
            bijdragen aan positieve resultaten en groei van mijn klanten.
            <br />
            Deze naam past bij mijn identiteit en mijn wens om met elke website
            of app een stukje vreugde en succes te brengen.
          </p>
        </div>
      </div>
